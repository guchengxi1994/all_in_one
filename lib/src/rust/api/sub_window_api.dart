...
Future<void> createEventLoop({dynamic hint}) =>
    RustLib.instance.api.crateApiSubWindowApiCreateEventLoop(hint: hint);

Future<void> showTodos(
        {required List<RustSimpleNotifyLibPinWindowItem> data, dynamic hint}) =>
    RustLib.instance.api.crateApiSubWindowApiShowTodos(data: data, hint: hint);

// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<rust_simple_notify_lib :: PinWindowItem>>
@sealed
