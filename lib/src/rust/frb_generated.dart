...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1113812267;
...
abstract class RustLibApi extends BaseApi {
  Stream<String> crateApiLlmApiAiHelperMessageStream({dynamic hint});

  Future<void> crateApiLlmApiAiHelperQuickRequest(
      {required String s,
  ...
  Future<void> crateApiLlmApiChat(
      {String? uuid,
  ...
  Stream<RustError> crateApiLlmApiErrorMessageStream({dynamic hint});

  Future<void> crateApiLlmApiGenerateFromTemplate(
      {required List<(String, int, int?, AttributeType, String?)> v,
      required bool enablePlugin,
      dynamic hint});

  Root? crateApiLlmApiGetDocRootFromStr({required String s, dynamic hint});

  EnvParams? crateApiLlmApiGetLlmConfig({dynamic hint});

  void crateApiLlmApiInitLlm({required String p, dynamic hint});

  void crateApiLlmApiInitPromptFromPath({required String s, dynamic hint});

  Stream<LLMMessage> crateApiLlmApiLlmMessageStream({dynamic hint});

  Future<String> crateApiLlmApiOptimizeDoc({required String s, dynamic hint});

  Future<void> crateApiLlmApiSequentialChainChat(
      {required String jsonStr, required String query, dynamic hint});

  Stream<TemplateResult> crateApiLlmApiTemplateMessageStream({dynamic hint});

  Future<String?> crateApiLlmApiTemplateRenderer(
      {required String template, dynamic hint});

  Stream<TemplateRunningStage> crateApiLlmApiTemplateStateStream(
      {dynamic hint});

  Future<List<(String, AttributeType, String?)>>
      crateApiLlmApiTemplateToPrompts({required String template, dynamic hint});

  Future<Map<String, String>?> crateApiLlmPluginApiEval(
      {required String sqlStr,
      required DatabaseInfo db,
      required List<(String, CellType)> keys,
      dynamic hint});

  Future<List<List<TableInfo>>> crateApiLlmPluginApiGetMysqlTableInfo(
      {required DatabaseInfo s, dynamic hint});

  Stream<String> crateApiLlmPluginApiMindMapStream({dynamic hint});

  Future<void> crateApiLlmPluginApiTextToMindMap(
      {required String s, dynamic hint});

  Future<List<ProcessPortMapper>>
      crateApiProcessPortMapperApiGetProcessPortMappers({dynamic hint});

  String crateApiSimpleGreet({required String name, dynamic hint});

  Future<void> crateApiSimpleInitApp({dynamic hint});

  Future<void> crateApiSoftwareMonitorApiAddToWatchingList(
      {required int id, required String name, dynamic hint});

  Future<List<Software>> crateApiSoftwareMonitorApiGetInstalledSoftwares(
      {dynamic hint});

  Future<void> crateApiSoftwareMonitorApiInitMonitor(
      {required List<(int, String)> items, dynamic hint});

  Future<void> crateApiSoftwareMonitorApiRemoveFromWatchingList(
      {required int id, dynamic hint});

  Stream<Int64List> crateApiSoftwareMonitorApiSoftwareWatchingMessageStream(
      {dynamic hint});

  Stream<(Int64List, String)>
      crateApiSoftwareMonitorApiSoftwareWatchingWithForegroundMessageStream(
          {dynamic hint});

  Future<void> crateApiSubWindowApiCreateEventLoop({dynamic hint});

  Future<void> crateApiSubWindowApiShowTodos(
      {required List<RustSimpleNotifyLibPinWindowItem> data, dynamic hint});

  Future<void> crateApiSystemMonitorApiStartSystemMonitor({dynamic hint});

  Stream<MonitorInfo> crateApiSystemMonitorApiSystemMonitorMessageStream(
      {dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<String> crateApiLlmApiAiHelperMessageStream({dynamic hint}) {
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLlmApiAiHelperMessageStreamConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiAiHelperMessageStreamConstMeta =>
      const TaskConstMeta(
        debugName: "ai_helper_message_stream",
        argNames: ["s"],
      );
  ...
  Future<void> crateApiLlmApiAiHelperQuickRequest(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmApiAiHelperQuickRequestConstMeta,
  ...
  TaskConstMeta get kCrateApiLlmApiAiHelperQuickRequestConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiLlmApiChat(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmApiChatConstMeta,
  ...
  TaskConstMeta get kCrateApiLlmApiChatConstMeta => const TaskConstMeta(
        debugName: "chat",
  ...
  @override
  Stream<RustError> crateApiLlmApiErrorMessageStream({dynamic hint}) {
    final s = RustStreamSink<RustError>();
    handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_StreamSink_rust_error_Sse(s, serializer);
      ...
      constMeta: kCrateApiLlmApiErrorMessageStreamConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiErrorMessageStreamConstMeta =>
      const TaskConstMeta(
        debugName: "error_message_stream",
        argNames: ["s"],
      );
  ...
  Future<void> crateApiLlmApiGenerateFromTemplate(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmApiGenerateFromTemplateConstMeta,
  ...
  TaskConstMeta get kCrateApiLlmApiGenerateFromTemplateConstMeta =>
      const TaskConstMeta(
  ...
  Root? crateApiLlmApiGetDocRootFromStr({required String s, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLlmApiGetDocRootFromStrConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiGetDocRootFromStrConstMeta =>
      const TaskConstMeta(
  ...
  EnvParams? crateApiLlmApiGetLlmConfig({dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLlmApiGetLlmConfigConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiGetLlmConfigConstMeta => const TaskConstMeta(
  ...
  void crateApiLlmApiInitLlm({required String p, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLlmApiInitLlmConstMeta,
      argValues: [p],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiInitLlmConstMeta => const TaskConstMeta(
        debugName: "init_llm",
        argNames: ["p"],
      );
  ...
  void crateApiLlmApiInitPromptFromPath({required String s, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLlmApiInitPromptFromPathConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiInitPromptFromPathConstMeta =>
      const TaskConstMeta(
        debugName: "init_prompt_from_path",
        argNames: ["s"],
      );
  ...
  Stream<LLMMessage> crateApiLlmApiLlmMessageStream({dynamic hint}) {
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLlmApiLlmMessageStreamConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiLlmMessageStreamConstMeta =>
      const TaskConstMeta(
  ...
  Future<String> crateApiLlmApiOptimizeDoc({required String s, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmApiOptimizeDocConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiOptimizeDocConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiLlmApiSequentialChainChat(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmApiSequentialChainChatConstMeta,
  ...
  TaskConstMeta get kCrateApiLlmApiSequentialChainChatConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiLlmApiTemplateMessageStreamConstMeta =>
      const TaskConstMeta(
  ...
  Future<String?> crateApiLlmApiTemplateRenderer(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmApiTemplateRendererConstMeta,
      argValues: [template],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiTemplateRendererConstMeta =>
      const TaskConstMeta(
  ...
  Stream<TemplateRunningStage> crateApiLlmApiTemplateStateStream(
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLlmApiTemplateStateStreamConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiTemplateStateStreamConstMeta =>
      const TaskConstMeta(
  ...
  @override
  Future<List<(String, AttributeType, String?)>>
      crateApiLlmApiTemplateToPrompts(
          {required String template, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
      ...
      constMeta: kCrateApiLlmApiTemplateToPromptsConstMeta,
      argValues: [template],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmApiTemplateToPromptsConstMeta =>
      const TaskConstMeta(
  ...
  Future<Map<String, String>?> crateApiLlmPluginApiEval(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmPluginApiEvalConstMeta,
  ...
  TaskConstMeta get kCrateApiLlmPluginApiEvalConstMeta => const TaskConstMeta(
        debugName: "eval",
  ...
  Future<List<List<TableInfo>>> crateApiLlmPluginApiGetMysqlTableInfo(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmPluginApiGetMysqlTableInfoConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmPluginApiGetMysqlTableInfoConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiLlmPluginApiMindMapStreamConstMeta =>
      const TaskConstMeta(
        debugName: "mind_map_stream",
        argNames: ["s"],
      );
  ...
  Future<void> crateApiLlmPluginApiTextToMindMap(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLlmPluginApiTextToMindMapConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiLlmPluginApiTextToMindMapConstMeta =>
      const TaskConstMeta(
        debugName: "text_to_mind_map",
        argNames: ["s"],
      );
  ...
  Future<List<ProcessPortMapper>>
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiProcessPortMapperApiGetProcessPortMappersConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiProcessPortMapperApiGetProcessPortMappersConstMeta =>
          const TaskConstMeta(
  ...
  Future<void> crateApiSoftwareMonitorApiAddToWatchingList(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSoftwareMonitorApiAddToWatchingListConstMeta,
      argValues: [id, name],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSoftwareMonitorApiAddToWatchingListConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<Software>> crateApiSoftwareMonitorApiGetInstalledSoftwares(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSoftwareMonitorApiGetInstalledSoftwaresConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSoftwareMonitorApiGetInstalledSoftwaresConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiSoftwareMonitorApiInitMonitor(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSoftwareMonitorApiInitMonitorConstMeta,
      argValues: [items],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSoftwareMonitorApiInitMonitorConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiSoftwareMonitorApiRemoveFromWatchingList(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSoftwareMonitorApiRemoveFromWatchingListConstMeta,
      argValues: [id],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiSoftwareMonitorApiRemoveFromWatchingListConstMeta =>
          const TaskConstMeta(
  ...
  Stream<Int64List> crateApiSoftwareMonitorApiSoftwareWatchingMessageStream(
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiSoftwareMonitorApiSoftwareWatchingMessageStreamConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiSoftwareMonitorApiSoftwareWatchingMessageStreamConstMeta =>
          const TaskConstMeta(
  ...
  Stream<(Int64List, String)>
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiSoftwareMonitorApiSoftwareWatchingWithForegroundMessageStreamConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiSoftwareMonitorApiSoftwareWatchingWithForegroundMessageStreamConstMeta =>
          const TaskConstMeta(
  ...
  Future<void> crateApiSubWindowApiCreateEventLoop({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSubWindowApiCreateEventLoopConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSubWindowApiCreateEventLoopConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiSubWindowApiShowTodos(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
            data, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiSubWindowApiShowTodosConstMeta,
      argValues: [data],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSubWindowApiShowTodosConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiSystemMonitorApiStartSystemMonitor({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSystemMonitorApiStartSystemMonitorConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSystemMonitorApiStartSystemMonitorConstMeta =>
      const TaskConstMeta(
  ...
  Stream<MonitorInfo> crateApiSystemMonitorApiSystemMonitorMessageStream(
    ...
    handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSystemMonitorApiSystemMonitorMessageStreamConstMeta,
      argValues: [s],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiSystemMonitorApiSystemMonitorMessageStreamConstMeta =>
          const TaskConstMeta(
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_RustSimpleNotifyLibPinWindowItem => wire
          .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_RustSimpleNotifyLibPinWindowItem => wire
          .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem;
  ...
  RustSimpleNotifyLibPinWindowItem
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
  ...
  @protected
  RustSimpleNotifyLibPinWindowItem
      dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return RustSimpleNotifyLibPinWindowItem.dcoDecode(raw as List<dynamic>);
  }
  ...
  ErrorModule dco_decode_error_module(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return ErrorModule.values[raw as int];
  }
  ...
  List<RustSimpleNotifyLibPinWindowItem>
      dco_decode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
  ...
  RustError dco_decode_rust_error(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return RustError(
      module: dco_decode_error_module(arr[0]),
      type: dco_decode_error_type(arr[1]),
      errmsg: dco_decode_String(arr[2]),
  ...
  @protected
  RustSimpleNotifyLibPinWindowItem
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
  ...
  @protected
  RustSimpleNotifyLibPinWindowItem
      sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return RustSimpleNotifyLibPinWindowItem.sseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  ...
  ErrorModule sse_decode_error_module(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return ErrorModule.values[inner];
  }
  ...
  @protected
  List<RustSimpleNotifyLibPinWindowItem>
      sse_decode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  RustError sse_decode_rust_error(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_module = sse_decode_error_module(deserializer);
    var var_type = sse_decode_error_type(deserializer);
  ...
  @protected
  void
      sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
  ...
  @protected
  void
      sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerrust_simple_notify_libPinWindowItem(
          RustSimpleNotifyLibPinWindowItem self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_StreamSink_rust_error_Sse(
    ...
    sse_encode_String(
        self.setupAndSerialize(
            codec: SseCodec(
                decodeSuccessData: sse_decode_rust_error,
                decodeErrorData: null)),
        serializer);
  }
  ...
  void sse_encode_rust_error(RustError self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_error_module(self.module, serializer);
    sse_encode_error_type(self.type, serializer);
